...
* [request-allowlist output](./request-allowlist-output.md "Response of nethesis-insights to an allowlist request, relayed as-is") – `http://schema.nethserver.org/crowdsec/request-allowlist-output.json`
