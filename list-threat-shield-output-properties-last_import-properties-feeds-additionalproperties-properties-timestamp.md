...
```txt
http://schema.nethserver.org/crowdsec/list-threat-shield-output.json#/properties/last_import/properties/feeds/additionalProperties/properties/timestamp
```

UTC timestamp of the last import run, same as last\_import.timestamp
