...
| :------------------------- | :-------- | :------- | :------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [enabled](#enabled)        | `boolean` | Optional | cannot be null | [Configure the insights blocklist-evidence webhook](set-insights-properties-enabled.md "http://schema.nethserver.org/crowdsec/set-insights.json#/properties/enabled")       |
...
* defined in: [Configure the insights blocklist-evidence webhook](set-insights-properties-enabled.md "http://schema.nethserver.org/crowdsec/set-insights.json#/properties/enabled")
...
Base URL of the nethesis-insights server that receives the decisions. Defaults to the production service when omitted.
