...
container=$(buildah from docker.io/alpine:3.24.2)
...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/crowdsecurity/crowdsec:v1.8.1-debian ${repobase}/crowdsec-firewall-bouncer:${IMAGETAG:-latest}" \
