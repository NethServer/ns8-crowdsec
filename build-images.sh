...
container=$(buildah from docker.io/alpine:3.22.3)
...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/crowdsecurity/crowdsec:v1.7.4-debian ${repobase}/crowdsec-firewall-bouncer:${IMAGETAG:-latest}" \
