...
container=$(buildah from docker.io/alpine:3.22.0)
...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/crowdsecurity/crowdsec:v1.6.8-debian ${repobase}/crowdsec-firewall-bouncer:${IMAGETAG:-latest}" \
