...
| [dynamicBanTimeAdvanced](#dynamicbantimeadvanced) | `boolean` | Required | cannot be null | [get-configuration output](get-configuration-output-properties-dynamicbantimeadvanced.md "http://schema.nethserver.org/crowdsec/get-configuration-output.json#/properties/dynamicBanTimeAdvanced") |
...
* Type: `boolean` ([dynamicBanTimeAdvanced](get-configuration-output-properties-dynamicbantimeadvanced.md))

* cannot be null

* defined in: [get-configuration output](get-configuration-output-properties-dynamicbantimeadvanced.md "http://schema.nethserver.org/crowdsec/get-configuration-output.json#/properties/dynamicBanTimeAdvanced")
